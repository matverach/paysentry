...
| Data Model | ✅ Completado | [03-data-model.md](docs/03-data-model.md) |
| ADRs | ✅ 4 completados | [docs/adr/](docs/adr/) |
| System Context (C4) | ⏳ Próximo | docs/architecture/ |
...
| ADR | Decisión | Estado |
|-----|----------|--------|
| [ADR-001](docs/adr/001-mock-adapter-mvp.md) | Mock Adapter para MVP | ✅ Accepted |
...
| Database | PostgreSQL |
| Cache | Redis |
| Procesador de Pagos | MercadoPago (Mock Adapter para MVP) |
